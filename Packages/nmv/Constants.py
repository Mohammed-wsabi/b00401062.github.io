...
TRACTS = (
	...
	Name(nickname = "A003_CBH", fullname = "Cingulum Bundle (Hippocampal)", indices = list(range(4, 6))),
	...
	Name(nickname = "A013_FSPF", fullname = "Frontal-Striatum (Prefrontal)", indices = list(range(36, 42))),
	Name(nickname = "A014_FSM", fullname = "Frontal-Striatum (Motor)", indices = list(range(42, 44))),
	...
	Name(nickname = "A017_AR", fullname = "Thalamic Radiation (Auditory Radiation)", indices = list(range(54, 56))),
	Name(nickname = "A018_OR", fullname = "Thalamic Radiation (Optic Radiation)", indices = list(range(56, 58))),
