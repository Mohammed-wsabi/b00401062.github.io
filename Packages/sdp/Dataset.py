...
class Dataset:
	...
	def get(index):
		...
		raw = loadmat("/Users/luo/Downloads/Projects/SDP/Datasets/all_array_{}.mat".format(index.lower()))
		...
		for set in Set._fields:
			file = "/Users/luo/Downloads/Projects/SDP/Datasets/{}.csv".format(set.capitalize())
