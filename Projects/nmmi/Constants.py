...
TRACTS = (
	...
	Name(nickname = "A015_TRPF", fullname = "Thalamic Radiation (Prefrontal)", indices = list(range(46, 50))),
	Name(nickname = "A016_TRSM", fullname = "Thalamic Radiation (Sensorimotor)", indices = list(range(50, 54))),
